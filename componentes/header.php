<header class="h-screen bg-[url(assets/images/bg-hero.png)] bg-cover bg-center" data-aos="zoom-out">
    <div class="mx-auto max-w-5xl flex flex-col gap-5 items-center text-center pt-20 md:pt-32">
        ...
        <div class="max-w-4xl">
            ...
            <p class="text-lg">
                Tenho um grande apreço por tecnologia e desenvolvimento de software. Atualmente, dedico-me à criação de aplicativos web, desenvolvimento de websites e construção de sistemas web dinâmicos
            </p>
        </div>
